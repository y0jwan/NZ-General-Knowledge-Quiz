"""Kids NZ General Knowledge Quiz - v4 Allow user to replay the quiz
...
if begin_quiz == "X":
    ...
    while restart_quiz != "X":
        ...
        if age < 8 and age > 4:
            ...
            print("Sorry, this quiz is only meant for kids age 5-11 year olds.")
        """Component 4 - Allow user to restart the quiz"""    
        restart_quiz = input("Would you like to restart the quiz? \n"
                             "Press 'Y' to restart or press 'X' to quit: ")
        if restart_quiz == "X":
